...
def map_view(data, center=(25.8, 93.0), zoom=6, height=650):

    # =========================================================
    # DARK SATELLITE BASE MAP
    # =========================================================
    ...
    # English boundaries and place names
    folium.TileLayer(
    ...
    states = [
        ...
        ("ASSAM", 26.20, 92.90),
        ("SIKKIM", 27.35, 88.60),
        ("MEGHALAYA", 25.50, 91.40),
        ("NAGALAND", 26.10, 94.60),
        ("MANIPUR", 24.70, 93.90),
        ("MIZORAM", 23.40, 92.80),
        ("TRIPURA", 23.80, 91.50),
    ]
    ...
    ">
        ...
        NORTHEAST INDIA — LANDSLIDE RISK INTELLIGENCE
    ...
    ">
        ...
        GEO-SPATIAL MONITORING • RAINFALL • SLOPE • RISK ANALYSIS

    </div>
    """

    fmap.get_root().html.add_child(
        folium.Element(subtitle_html)
    )
